...
public class CombinedCommands {
    ...
    public static Command feedPieceAcrossField(CommandXboxController joystick, ChassisSubsystem chassis, ArmPivotSubsystem arm, ShooterSubsystem shooter, IntakeSubsystem intake) {
        ...
        return Commands.parallel(
            ...
            arm.createMoveArmToAngleCommand(0),
    ...
    public static Command autoScoreInAmp(ChassisSubsystem chassis, ArmPivotSubsystem arm) {
        return Commands.parallel(
            chassis.createDriveToAmpCommand(),
            Commands.waitUntil(() -> chassis.getDistanceToAmp() < Units.feetToMeters(2)).andThen(arm.createMoveArmToAmpAngleCommand())
        );
