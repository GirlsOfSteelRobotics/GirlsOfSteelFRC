...
public class FeedPiecesWithVision extends Command {
    ...
    private GosDoubleProperty m_xVelInp = new GosDoubleProperty(false, "input x-velocity", -1);
    private GosDoubleProperty m_yVelInp = new GosDoubleProperty(false, "input y-velocity", -1);
...
//        m_distanceToRPMTable.put(10.9, 4300.0);
//        m_RPMtoCurveOffsetTable.put(10.9, 15.0);
    ...
    public void execute() {
        ...
        double chassisXVel = m_xVelInp.getValue(); //leftY * ChassisSubsystem.MAX_TRANSLATION_SPEED;
        double chassisYVel = m_yVelInp.getValue(); //leftX * ChassisSubsystem.MAX_TRANSLATION_SPEED;

        double distanceToFeed = m_chassisSubsystem.getDistanceToFeeder();
        ...
        m_chassisSubsystem.turnButtToFacePoint(
            m_chassisSubsystem.getFuturePose(),
            aimingPoint,
            chassisXVel,
            chassisYVel,
            curveOffset);
