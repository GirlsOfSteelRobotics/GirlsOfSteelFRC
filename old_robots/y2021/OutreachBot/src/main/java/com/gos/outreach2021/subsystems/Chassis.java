...
import com.gos.outreach2021.subsystems.sim.CameraSimulator;
...
public class Chassis extends SubsystemBase {
    ...
    public Chassis() {
        ...
        m_rightFront = new SimableCANSparkMax(1, CANSparkLowLevel.MotorType.kBrushless);
        m_rightFront.setInverted(false);

        m_rightBack = new SimableCANSparkMax(2, CANSparkLowLevel.MotorType.kBrushless);
        m_rightBack.setInverted(false);

        m_leftFront = new SimableCANSparkMax(3, CANSparkLowLevel.MotorType.kBrushless);
        m_leftFront.setInverted(false);

        m_leftBack = new SimableCANSparkMax(4, CANSparkLowLevel.MotorType.kBrushless);
