...
public class Shooter extends SubsystemBase {
    ...
    private final SparkPIDController m_wheelPidController;
    ...
    private final SparkPIDController m_hoodPidController;
    ...
    public Shooter() {
        ...
        m_wheelEncoder = m_shooterWheel.getEncoder(SparkRelativeEncoder.Type.kQuadrature, 8192);
        m_wheelPidController = m_shooterWheel.getPIDController();

        m_wheelPidController.setFF(0.4);
        m_wheelPidController.setP(0.4);

        m_hoodEncoder = m_shooterHood.getEncoder(SparkRelativeEncoder.Type.kQuadrature, 8192);
