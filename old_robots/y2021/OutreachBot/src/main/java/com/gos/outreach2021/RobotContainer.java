...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        autoLine.onTrue(new DrivePastAutoLine(m_chassis));
        ...
        extendCollector.whileTrue(new ExtendCollector(m_collector));
        ...
        retractCollector.whileTrue(new RetractCollector(m_collector));
        ...
        setHoodAngleUp.whileTrue(new SetHoodAngleCommand(m_shooter, 20));
        ...
        setHoodAngleDown.whileTrue(new SetHoodAngleCommand(m_shooter, 60));
        ...
        intakeBall.whileTrue(new IntakeBall(m_collector));
        ...
        reverseBall.whileTrue(new ReverseBall(m_collector));
        ...
        runShooter.onTrue(new RunShooter(3500, m_shooter));
        ...
        stopShooter.onTrue(new StopShooter(m_shooter));
        ...
        autoShoot.onTrue(new AutoShoot(m_shooter));
