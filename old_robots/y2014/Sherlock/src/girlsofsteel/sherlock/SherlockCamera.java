...
public class SherlockCamera extends WPICameraExtension {
    ...
    IntegerProperty redThreshold = new IntegerProperty(this, "Red Maximum", 250);
    ...
    DoubleProperty slope = new DoubleProperty(this, "Slope", 6.793177090893384);//based on meter data
    DoubleProperty yInt = new DoubleProperty(this, "Y Intercept", -0.09952646791659303);
...
//            rawImage.drawLine(tm, bm, WPIColor.WHITE, 4);
            ...
            if (biggestPoly != null) {
                rawImage.drawPolygon(biggestPoly, WPIColor.CYAN, 4);
            }
            ...
            if (secondBiggestPoly != null) {
                ...
                if ((smallCenterpoint.getX() < bigCenterpoint.getX() + differenceInPixels.getValue()
                    ...
                    rawImage.drawPolygon(secondBiggestPoly, WPIColor.MAGENTA, 4);
            ...
            if (biggestPoly != null) {
                ...
                double trueAverageHeight = heightAverage / rawImage.getHeight() ;


                distanceToBackWall = slope.getValue().doubleValue() / trueAverageHeight + yInt.getValue().doubleValue(); //distance from center of Watson to wall. !!! IN MEETERS!!!!
                //System.out.println(distanceToBackWall);
                ...
                // Draw it
                rawImage.drawPolygon(biggestPoly, WPIColor.RED, 5);
//                if (dataCount <= 10) {
//                    dataCount++;
...
//                    double meanDiffference = (sumOfCenterpointDifferences / dataCount);
                    ...
                    table.putDouble("xDifference", difference);
                    table.putDouble("distanceToBottomTarget", distanceToBackWall);
                    table.putDouble("imageTargetRatio", trueAverageHeight);

                    //System.out.println(meanAverageTargetHight);

                    // RobotTable.getTable

                    System.out.println(trueAverageHeight + " --> "
                            + (distanceToBackWall) + " Meters");
//                    dataCount = 0;
//                    sumOfDistances = 0;
