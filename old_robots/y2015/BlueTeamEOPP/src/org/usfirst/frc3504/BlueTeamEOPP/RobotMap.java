...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveSystemleftTalon = new Talon(1);
//    addChild("leftTalon", (Talon) driveSystemleftTalon);

        driveSystemrightTalon = new Talon(2);
//    addChild("rightTalon", (Talon) driveSystemrightTalon);
        ...
        shootershooterTalon = new Talon(3);
//    addChild("shooterTalon", (Talon) shootershooterTalon);
