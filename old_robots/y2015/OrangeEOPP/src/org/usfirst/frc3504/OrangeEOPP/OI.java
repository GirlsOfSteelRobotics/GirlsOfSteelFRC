...
public class OI {
    ...
    public DigitalIOButton tiltButton;
    public DigitalIOButton homeButton;
    ...
    public OI() {
        ...
        tiltButton = new DigitalIOButton(1);
        tiltButton.whileHeld(new Tilt());

        homeButton = new DigitalIOButton(2);
        homeButton.whileHeld(new Home());
