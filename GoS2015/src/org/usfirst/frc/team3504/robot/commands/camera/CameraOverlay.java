...
public class CameraOverlay extends Command {
	...
	protected void execute() {
		...
		NIVision.imaqDrawShapeOnImage(frame, frame, top, DrawMode.PAINT_VALUE, ShapeMode.SHAPE_RECT, 255.0f/*
																											 * this
																											 * number
																											 * makes
																											 * the
																											 ...
																											 * red
																											 */);
		NIVision.imaqDrawShapeOnImage(frame, frame, side, DrawMode.PAINT_VALUE, ShapeMode.SHAPE_RECT, 255.0f);
