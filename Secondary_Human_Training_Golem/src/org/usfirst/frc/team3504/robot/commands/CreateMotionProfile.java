...
public class CreateMotionProfile extends Command {
	...
	private ArrayList<ArrayList<Double>> leftTrajectory; // filled with
															// arraylists of
															// points
	private ArrayList<ArrayList<Double>> rightTrajectory; // filled with
															// arraylists of
															// points
	public CANTalon leftTalon = Robot.chassis.getLeftTalon();
	public CANTalon rightTalon = Robot.chassis.getRightTalon();
	private ArrayList<Double> leftPoint; // position (rev), velocity (rpm),
											// duration
	private ArrayList<Double> rightPoint; // position (rev), velocity (rpm),
											// duration
	...
	protected void execute() {
		...
		rightPoint.add(rightVelocity / RobotMap.CODES_PER_WHEEL_REV); // is this
																		// in
																		// RPM?
