...
def create_path_between_variables(choreo_dir, variables, first_variable, second_variable):
    ...
    constraints = ['    {"from":0, "to":' + str(len(waypoints) -1) + ', "data":{"type":"MaxVelocity", "props":{"max":{"exp":"DefaultMaxVelocity", "val":1.524}}}, "enabled":true}']

    path_to_write.write_text(template.render(
