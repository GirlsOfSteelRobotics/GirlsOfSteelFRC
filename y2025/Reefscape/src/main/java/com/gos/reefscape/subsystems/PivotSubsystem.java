...
public class PivotSubsystem extends SubsystemBase {
    ...
    public static final GosDoubleProperty PIVOT_TUNABLE_ANGLE = new GosDoubleProperty(Constants.DEFAULT_CONSTANT_PROPERTIES, "tunablePivot", -21);
    ...
    public PivotSubsystem() {
        ...
        m_armPidController = new RevProfiledSingleJointedArmController.Builder("Arm Pivot", true, m_pivotMotor, pivotConfig, ClosedLoopSlot.kSlot0)
            // Speed Limits
            .addMaxVelocity(180)
