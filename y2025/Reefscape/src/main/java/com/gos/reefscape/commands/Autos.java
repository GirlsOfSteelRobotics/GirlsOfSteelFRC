...
public final class Autos {
    ...
    public Autos(ChassisSubsystem swerveDrive, CombinedCommands combinedCommands) {
        ...
        createMultiCoralAuto(swerveDrive, combinedCommands, PIE.L1, StartingPositions.CENTER, List.of(CoralPositions.G));
        createMultiCoralAuto(swerveDrive, combinedCommands, PIE.L4, StartingPositions.RIGHT, List.of(
        ...
        createMultiCoralAuto(swerveDrive, combinedCommands, PIE.L4, StartingPositions.RIGHT, List.of(CoralPositions.E, CoralPositions.B, CoralPositions.C));
        createMultiCoralAuto(swerveDrive, combinedCommands, PIE.L4, StartingPositions.LEFT, List.of(
            CoralPositions.H,
            CoralPositions.I,
            CoralPositions.J,
            CoralPositions.K,
        ...
        createMultiAlgaeAuto(swerveDrive, combinedCommands, PIE.L3, CoralPositions.H, StartingPositions.CENTER, List.of(AlgaePositions.GH, AlgaePositions.EF, AlgaePositions.IJ));
    ...
    private void createMultiCoralAuto(ChassisSubsystem chassis, CombinedCommands combinedCommands, PIE height, StartingPositions starting, List<CoralPositions> positions) {
    ...
    private void createMultiAlgaeAuto(ChassisSubsystem swerveDrive, CombinedCommands combinedCommands, PIE height, CoralPositions coralPosition, StartingPositions start, List<AlgaePositions> algaelist) {
