...
from .pathing_generation_utils.test_paths_utils import generate_straight_paths, generate_rotation_paths, write_debug_tab_file
...
def generate_test_paths(project_dir, package_name, output_trajectory_dir, run_cli):
    ...
    all_paths.extend(generate_straight_paths(output_trajectory_dir, straight_accelerations, straight_velocities, start_waypoint, end_waypoint))
