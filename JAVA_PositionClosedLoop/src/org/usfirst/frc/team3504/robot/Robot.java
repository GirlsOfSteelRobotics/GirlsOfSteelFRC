...
public class Robot extends IterativeRobot {
	...
	CANTalon _talon2 = new CANTalon(2);
	...
	public void robotInit() {
		_talon2.changeControlMode(CANTalon.TalonControlMode.Follower);
		_talon2.set(_talon.getDeviceID());
    ...
    public void teleopPeriodic() {
        ...
        if(!_lastButton1 && button1) {
        	...
        	targetPositionRotations = leftYstick * 300.0; /* 300 Rotations in either direction */
        	_talon.changeControlMode(TalonControlMode.Position);
        	_talon.set(targetPositionRotations); /* 300 rotations in either direction */
