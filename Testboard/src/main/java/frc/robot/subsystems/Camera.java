...
public class Camera extends Subsystem {
	...
	public UsbCamera visionCam, driverCam;
	...
	public Camera() {
		...
		driverCam = CameraServer.getInstance().startAutomaticCapture("Driver Camera", RobotMap.DRIVER_CAMERA);
		driverCam.setResolution(WIDTH, HEIGHT);
		driverCam.setFPS(20);
		...
		// Create a second Camera Server stream that we'll fill with processed frames in
		// GripPipelineListener
