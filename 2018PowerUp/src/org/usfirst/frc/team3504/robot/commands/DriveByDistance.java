...
public class DriveByDistance extends Command {
	...
	private double rotations; //in sensor units
	...
	protected boolean isFinished() {
		...
		if (rotations > 0) {
			if ((rightTalon.getSelectedSensorPosition(0) > (rotations + rightInitial))
