...
public class GoSPIDController implements Runnable {
    ...
    public void enable(){
        ...
        PIDEnabled = true;
        System.out.println("Enable has been called. " + "PID Enabled " + PIDEnabled);
    ...
    public synchronized void disable(){
        ...
        System.out.println("PID is disabled. " + PIDEnabled);
    ...
    public void run(){
        ...
        while(PIDEnabled){ //must be set to run -> through setSetPoint
            ...
            DriverStationLCD.getInstance().println(DriverStationLCD.Line.kUser5,
                    1,"errorSum: " + errorSum);
            DriverStationLCD.getInstance().println(DriverStationLCD.Line.kUser6, 1, "Kp" + Kp);
