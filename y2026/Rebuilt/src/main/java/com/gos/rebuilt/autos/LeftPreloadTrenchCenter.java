...
public class LeftPreloadTrenchCenter extends GosAuto {
    public LeftPreloadTrenchCenter(ChassisSubsystem chassisSubsystem, CombinedCommand combinedCommand) {
        ...
        addCommands(new ParallelDeadlineGroup(followChoreoPath("LeftShootTrenchCenter"), combinedCommand.intake()));
