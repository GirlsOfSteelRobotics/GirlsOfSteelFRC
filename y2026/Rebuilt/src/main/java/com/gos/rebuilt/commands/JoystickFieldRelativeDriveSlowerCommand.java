...
public class JoystickFieldRelativeDriveSlowerCommand extends Command {
    private static final GosDoubleProperty TRANSLATION_DAMPER = new GosDoubleProperty(Constants.DEFAULT_CONSTANT_PROPERTIES, "ChassisTranslationSlowDamper", 0.25);
    private static final GosDoubleProperty ROTATIONAL_DAMPER = new GosDoubleProperty(Constants.DEFAULT_CONSTANT_PROPERTIES, "ChassisRotationSlowDamper", .5);
