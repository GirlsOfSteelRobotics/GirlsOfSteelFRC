...
//        m_chooser.addOption("Middle > Depot > Outpost", new MiddleDepotOutpostShoot(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Right Preload > Trench > Center", new RightPreloadTrenchCenter(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Left Preload > Trench > Center", new LeftPreloadTrenchCenter(chassisSubsystem, combinedCommand));

        m_chooser.addOption("Left > Depot > Shoot", new ShootLeftDepot(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Middle Preload > Depot > Shoot", new MiddleShootDepot(chassisSubsystem, combinedCommand));
        ...
        m_chooser.addOption("Middle Preload > Left Bump > Intake Center", new MiddleLeftBumpCenter(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Middle Preload > Right Bump > Intake Center", new MiddleRightBumpCenter(chassisSubsystem, combinedCommand));
