...
public class AutoFactory {
    ...
    public AutoFactory(ChassisSubsystem chassisSubsystem, CombinedCommand combinedCommand) {
        ...
        m_chooser.addOption("Left -> Preload", new StartLeftPreload(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Left -> Trench -> Collect", new LeftTrenchCenter(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Left -> Trench -> Collect -> Bump -> Shoot", new LeftTrenchCenterBump(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Left  -> Preload -> Trench", new LeftPreloadTrenchCenter(chassisSubsystem, combinedCommand));

        m_chooser.addOption("Middle -> Preload", new StartMiddleShootMiddle(chassisSubsystem, combinedCommand));

        m_chooser.addOption("Right -> Preload", new StartRightPreload(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Right -> Trench -> Collect -> Trench", new RightTrenchCenter(chassisSubsystem, combinedCommand));
        m_chooser.addOption("Right -> Preload -> Trench", new RightPreloadTrenchCenter(chassisSubsystem, combinedCommand));
