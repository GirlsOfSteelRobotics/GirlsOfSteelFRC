package com.gos.rebuilt.LED_patternss;
...
public class EnabledPatties {
    ...
    public EnabledPatties (AddressableLEDBuffer addressme, ShooterSubsystem shooter, ChassisSubsystem chassis, PivotSubsystem pivot) {
