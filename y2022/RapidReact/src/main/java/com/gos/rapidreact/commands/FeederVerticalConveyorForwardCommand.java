...
public class FeederVerticalConveyorForwardCommand extends CommandBase {
    private final VerticalConveyorSubsystem m_verticalConveyor;

    public FeederVerticalConveyorForwardCommand(VerticalConveyorSubsystem verticalConveyorSubsystem) {
