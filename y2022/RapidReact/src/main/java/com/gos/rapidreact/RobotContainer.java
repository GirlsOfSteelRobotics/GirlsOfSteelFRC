...
public class RobotContainer {
    ...
    private final LEDManagerSubsystem m_led = new LEDManagerSubsystem(m_intakeLimelight, m_shooterLimelight, m_shooter, m_horizontalConveyor, m_verticalConveyor); // NOPMD
