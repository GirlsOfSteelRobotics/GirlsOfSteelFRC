...
public class AutoLimelightConveyorAndShooterCommand extends CommandBase {
    ...
    public AutoLimelightConveyorAndShooterCommand(ShooterLimelightSubsystem shooterLimelightSubsystem, ShooterSubsystem shooterSubsystem, VerticalConveyorSubsystem verticalConveyorSubsystem) {
