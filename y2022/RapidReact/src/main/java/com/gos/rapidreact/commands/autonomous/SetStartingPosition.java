...
public class SetStartingPosition extends CommandBase {
    ...
    public SetStartingPosition(ChassisSubsystem chassis, double x, double y, double angle) {
        m_chassis = chassis;
        m_xValue = x;
        m_yValue = y;
        m_angle = angle;
    ...
    public SetStartingPosition(ChassisSubsystem chassis, Pose2d startingPosition) {
        this(chassis,
    ...
    @Override
    public void execute() {
        m_chassis.setPositionMeters(m_xValue, m_yValue, m_angle);
        ++m_loopsRun;
    }
