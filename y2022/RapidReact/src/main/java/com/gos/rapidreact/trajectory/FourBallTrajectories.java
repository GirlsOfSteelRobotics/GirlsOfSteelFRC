...
public class FourBallTrajectories {
    ...
    public static Command fourBallPart2(ChassisSubsystem chassis) {
        TrajectoryConfig config = TrajectoryUtils.getTrajectoryConfig();
    ...
    public static Command fourBallPart3(ChassisSubsystem chassis) {
        return TrajectoryUtils.createTrajectory("PathWeaver/Paths/4Ball_Part3path", TrajectoryUtils.getTrajectoryConfig(), chassis);
    }
