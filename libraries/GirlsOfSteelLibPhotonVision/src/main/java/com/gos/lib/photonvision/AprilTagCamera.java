...
public class AprilTagCamera {
    ...
    public AprilTagCamera(AprilTagFieldLayout aprilTagLayout, BaseGosField field, String name, TunableTransform3d transform3d, Matrix<N3, N1> singleTagStddev, Matrix<N3, N1> multiTagStddev) {
        this(aprilTagLayout, field, name, transform3d, DEFAULT_SINGLE_TAG_MAX_DISTANCE, DEFAULT_SINGLE_TAG_MAX_AMBIGUITY, singleTagStddev, multiTagStddev, DEFAULT_DEBUG_CONFIG);
    }
     ...
     */
    public AprilTagCamera(AprilTagFieldLayout aprilTagLayout, BaseGosField field, String name, TunableTransform3d transform3d, double singleTagMaxDistance, double singleTagMaxAmbiguity, Matrix<N3, N1> singleTagStddev, Matrix<N3, N1> multiTagStddev, DebugConfig fieldDebugSettings) {
        m_cameraName = name;
