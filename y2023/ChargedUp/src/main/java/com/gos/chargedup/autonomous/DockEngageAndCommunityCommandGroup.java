...
public class DockEngageAndCommunityCommandGroup extends SequentialCommandGroup {
    ...
    public static final PathPlannerTrajectory DOCK_ENGAGE_AND_COMMUNITY = PathPlanner.loadPath("DockandEngage_Community", new PathConstraints(Constants.AUTO_VELOCITY, Constants.AUTO_ACCELERATION));
