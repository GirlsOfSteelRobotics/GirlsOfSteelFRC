...
public class RobotContainer {
    ...
    private void createTestCommands() {
        ...
        tab.add("Arm: Angle PID - 0 degrees", m_arm.commandPivotArmToAngleReg(0));
        tab.add("Arm: Angle PID - 45 degrees", m_arm.commandPivotArmToAngleReg(45));
        tab.add("Arm: Angle PID - 90 degrees", m_arm.commandPivotArmToAngleReg(90));
