...
public final class AutonomousFactory {
    ...
    public AutonomousFactory(ChassisSubsystem chassis, TurretSubsystem turret, ArmPivotSubsystem armPivot, ArmExtensionSubsystem armExtension, ClawSubsystem claw) {
        ...
        for (AutoPivotHeight height : AutoPivotHeight.values()) {
            ...
            m_autoOptions.get(height).put(AutonMode.ENGAGE_AND_LEAVE_COMMUNITY, new EngageAndLeaveCommunityCommandGroup(chassis));
        }
        ...
        m_armHeight.addOption("Medium", AutoPivotHeight.MEDIUM);
        m_armHeight.setDefaultOption("High", AutoPivotHeight.HIGH);
