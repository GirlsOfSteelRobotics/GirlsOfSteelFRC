...
public class ClawSubsystem extends SubsystemBase {
    ...
    public ClawSubsystem() {
        ...
        m_rightIntake = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.CLAW_INTAKE_RIGHT);
        m_leftIntake = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.CLAW_INTAKE_LEFT);
