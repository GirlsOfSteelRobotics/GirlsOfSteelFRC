...
public class LEDManagerSubsystem extends SubsystemBase {
    ...
    public LEDManagerSubsystem(ChassisSubsystemInterface chassisSubsystem, ArmPivotSubsystem armSubsystem, ClawSubsystem claw, AutonomousFactory autonomousFactory) {
