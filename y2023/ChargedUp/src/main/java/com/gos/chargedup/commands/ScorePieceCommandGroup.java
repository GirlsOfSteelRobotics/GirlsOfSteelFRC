...
public class ScorePieceCommandGroup extends SequentialCommandGroup {
    ...
    public ScorePieceCommandGroup(TurretSubsystem turret, ArmSubsystem arm, ClawSubsystem claw, AutoEnumsWithScorePiece piece) {
        //assuming robot is in correct position to score (intake facing nodes)
        //arm to angle, arm extend, drop piece
        addCommands(arm.commandMoveArmToPieceScorePosition(piece));
