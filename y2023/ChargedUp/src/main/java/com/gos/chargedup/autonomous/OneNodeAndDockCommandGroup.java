...
public class OneNodeAndDockCommandGroup extends SequentialCommandGroup {
    ...
    public static final PathPlannerTrajectory ONE_NODE_AND_DOCK = PathPlanner.loadPath("OneNodeandDock", new PathConstraints(Constants.AUTO_VELOCITY, Constants.AUTO_ACCELERATION));
