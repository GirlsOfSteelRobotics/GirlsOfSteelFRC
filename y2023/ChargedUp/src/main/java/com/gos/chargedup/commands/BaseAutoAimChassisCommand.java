...
public abstract class BaseAutoAimChassisCommand extends CommandBase {
    ...
    public BaseAutoAimChassisCommand(ArmPivotSubsystem armSubsystem, ChassisSubsystem chassisSubsystem, LEDManagerSubsystem ledManagerSubsystem, ArmExtensionSubsystem armExtension) {
    ...
    protected void runAutoAim(Translation2d baseNodeLocation, double targetPitch) {
        ...
        // accoutn for how the "turret" is off center
        ...
        if (m_clawAlignedCheck.isClawAtPoint(nodePosAbs, m_chassisSubsystem.getYaw())) {
            System.out.println("Is claw aligned: " + m_clawAlignedCheck.isClawAtPoint(nodePosAbs, m_chassisSubsystem.getYaw()));
