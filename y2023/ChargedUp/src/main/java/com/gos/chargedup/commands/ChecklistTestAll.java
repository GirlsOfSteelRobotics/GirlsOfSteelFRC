...
public class ChecklistTestAll extends SequentialCommandGroup {
    ...
    public ChecklistTestAll(DoubleSupplier pressureSupplier, TankDriveChassisSubsystem chassis, ArmPivotSubsystem armPivot, ArmExtensionSubsystem armExtension, ClawSubsystem claw) {
