...
public class ScoreHighCubeAtCurrentPosCommandGroup extends SequentialCommandGroup {
    public ScoreHighCubeAtCurrentPosCommandGroup(TurretSubsystem turret, ArmSubsystem arm, ClawSubsystem claw, AutoEnumsWithScorePiecePivot piece, GamePieceType gamePieceType) {
