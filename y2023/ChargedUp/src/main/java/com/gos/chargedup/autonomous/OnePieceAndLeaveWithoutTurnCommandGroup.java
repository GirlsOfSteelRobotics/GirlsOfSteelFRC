...
public class OnePieceAndLeaveWithoutTurnCommandGroup extends SequentialCommandGroup {
    public OnePieceAndLeaveWithoutTurnCommandGroup(ChassisSubsystem chassis, ArmPivotSubsystem armPivot,
