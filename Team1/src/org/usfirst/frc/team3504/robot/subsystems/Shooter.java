...
public class Shooter extends Subsystem {
	...
	public Shooter()
	{
		shooterPistonLeft = new DoubleSolenoid(RobotMap.PCM_A, RobotMap.SHOOTER_PISTON_LEFT_A, RobotMap.SHOOTER_PISTON_LEFT_B);
		shooterPistonRight = new DoubleSolenoid(RobotMap.PCM_A, RobotMap.SHOOTER_PISTON_RIGHT_A, RobotMap.SHOOTER_PISTON_RIGHT_B);
